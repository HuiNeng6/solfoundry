...
class ErrorResponse(BaseModel):
    ...
    details: Optional[List[ErrorDetail]] = Field(
        None, description="Detailed error information for specific fields"
    )
    correlation_id: Optional[str] = Field(
        None, description="Request correlation ID for debugging and support"
    )
    ...
    path: Optional[str] = Field(
        None, description="The request path that caused the error"
    )
    documentation_url: Optional[str] = Field(
        None, description="Link to documentation for this error type"
    )
...
class AppException(Exception):
    ...
    def to_response(
        self, correlation_id: Optional[str] = None, path: Optional[str] = None
    ) -> ErrorResponse:
