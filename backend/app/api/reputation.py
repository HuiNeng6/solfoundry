...
Note: Fixed-path routes (skills, summary) must be defined BEFORE dynamic-path routes ({contributor_id})
to ensure proper routing in FastAPI.
"""
...
# ---------------------------------------------------------------------------
# Available Skills Endpoint (MUST be before {contributor_id} routes)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Reputation Summary Endpoint (MUST be before {contributor_id} routes)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Contributor Reputation Details (MUST be after fixed-path routes)
# ---------------------------------------------------------------------------
